...
public class TerapiaDao {
	...
	public List<Terapia> buscar(Terapia _terapia, int buscarPor){
		...
		case 1://	ID
			...
			break;
		case 2://	NOME
			query = query  + " like % " +  _terapia.getNome()      + " %"; 
			break;
		case 3://	ORIGEM
			query = query  + " like % " +  _terapia.getOrigem()    + " %"; 
			break;
		case 4://	PRINCIPIO
			query = query  + " like % " + _terapia.getPrincipio()  + " %";  
			break;
		case 5://	SUBSTANCIA
			query = query  + " like % " + _terapia.getSubstancia() + " %";  
			break;
